...
import javax.swing.text.*; 
    ...
    class Module2 implements Cloneable
   {
      ...
      protected Vector upBounds, lowBounds, inputVarValues;
      ...
      private int realMaxVarLength = maxVarLength+1;
       ...
       public String[] getInputVariablesToStrings(){
         return ((String[]) inputVars.toArray(new String[inputVars.size()]));
      }

       public int getInputVariablesSize() {
       ...
       public int getOutputVariablesSize() {
         return outputVars.size();
       }
       public String[] getOutputVariablesToStrings() {
         String[] sTmp = (String[])outputVars.toArray(new String[outputVars.size()]);
         return (sTmp);
       }
